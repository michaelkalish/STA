...
public class GeneralModelTests {
	...
	public static int[][] delayInitData = { { 1, 2, 1 }, { 2, 1, 2 }, { 3, 1, 1 }, { 4, 2, 2 }, { 5, 2, 1 }, { 6, 1, 2 }, { 7, 1, 1 },
			{ 8, 2, 2 }, { 9, 2, 1 }, { 10, 2, 1 }, { 11, 1, 1 }, { 12, 2, 2 }, { 13, 2, 1 }, { 14, 1, 2 },
			{ 15, 1, 1 }, { 16, 2, 2 }, { 17, 2, 1 }, { 18, 1, 2 }, { 19, 1, 1 }, { 20, 2, 2 }, { 21, 2, 1 },
			{ 22, 2, 1 }, { 23, 1, 1 }, { 24, 2, 2 }, { 25, 2, 1 }, { 26, 1, 2 }, { 27, 1, 1 }, { 28, 2, 2 },
			{ 29, 2, 1 }, { 30, 1, 2 }, { 31, 1, 1 }, { 32, 2, 2 }, { 33, 2, 1 }, { 34, 1, 2 }, { 35, 1, 1 },
			{ 36, 2, 2 }, { 37, 2, 1 }, { 38, 1, 2 }, { 39, 1, 1 }, { 40, 2, 2 }, { 41, 2, 1 }, { 42, 1, 2 },
			{ 43, 1, 1 }, { 44, 2, 2 }, { 45, 2, 1 }, { 46, 1, 2 }, { 47, 1, 1 }, { 48, 2, 2 }, { 49, 2, 1 },
			{ 50, 1, 2 }, { 51, 1, 1 }, { 52, 2, 2 }, { 53, 2, 1 }, { 54, 1, 2 }, { 55, 1, 1 }, { 56, 2, 2 },
			{ 57, 2, 1 }, { 58, 1, 2 }, { 59, 1, 1 }, { 60, 2, 2 }, { 61, 2, 1 }, { 62, 1, 2 }, { 63, 1, 1 },
			{ 64, 2, 2 }, { 66, 1, 2 }, { 67, 1, 1 }, { 68, 2, 2 }, { 69, 2, 1 }, { 71, 1, 2 }, { 72, 1, 1 },
			{ 73, 2, 1 }, { 74, 1, 2 }, { 75, 1, 1 }, { 76, 2, 2 }, { 77, 2, 1 }, { 78, 1, 2 }, { 79, 1, 1 },
			{ 80, 2, 2 }, { 81, 2, 1 }, { 82, 1, 2 }, { 83, 1, 1 }, { 84, 2, 2 }, { 85, 2, 1 }, { 86, 1, 2 },
			{ 87, 1, 1 }, { 91, 1, 1 }, { 92, 2, 2 }, { 94, 1, 2 }, { 95, 1, 1 }, { 96, 2, 2 }, { 97, 2, 1 },
			{ 98, 1, 2 }, { 99, 1, 1 }, { 100, 2, 2 }, { 101, 2, 1 }, { 102, 1, 2 }, { 103, 1, 1 }, { 105, 2, 1 },
			{ 106, 1, 2 }, { 107, 1, 1 }, { 108, 2, 2 }, { 109, 2, 1 }, { 110, 1, 2 }, { 111, 1, 1 }, { 112, 2, 2 },
			{ 113, 2, 1 }, { 115, 1, 1 }, { 116, 2, 2 }, { 117, 2, 1 }, { 118, 1, 2 }, { 120, 2, 2 }, { 121, 2, 1 },
			{ 123, 1, 1 }, { 124, 2, 2 }, { 125, 2, 1 }, { 126, 1, 2 }, { 127, 1, 1 }, { 128, 2, 2 }, { 129, 2, 1 },
			{ 130, 1, 2 }, { 131, 1, 1 }, { 132, 2, 2 }, { 133, 2, 1 }, { 134, 1, 2 }, { 135, 1, 1 }, { 136, 2, 2 },
			{ 137, 2, 1 }, { 138, 1, 2 }, { 139, 1, 1 }, { 140, 2, 2 } };

	public static double[][] delayData = { { 0.3375, 0.8875, 0.9375, 1 }, { 0.2875, 0.475, 0.7, 0.7625 }, { 0.525, 0.6, 0.9, 0.925 },
			{ 0.35, 0.3, 0.575, 0.45 }, { 0.2375, 0.2625, 0.225, 0.2875 }, { 0.2125, 0.2875, 0.6875, 0.7625 },
			{ 0.5125, 0.85, 0.9625, 0.8875 }, { 0.4375, 0.55, 0.4625, 0.475 }, { 0.2, 0.225, 0.275, 0.25 },
			{ 0.275, 0.1375, 0.25, 0.2625 }, { 0.3125, 0.2, 0.3375, 0.25 }, { 0.225, 0.2375, 0.2375, 0.3125 },
			{ 0.2625, 0.4375, 0.425, 0.4875 }, { 0.25, 0.3625, 0.275, 0.25 }, { 0.3, 0.3125, 0.5, 0.3625 },
			{ 0.3, 0.25, 0.2375, 0.2375 }, { 0.55, 0.8125, 0.8625, 0.9375 }, { 0.225, 0.325, 0.2375, 0.3125 },
			{ 0.3, 0.4125, 0.3875, 0.575 }, { 0.2375, 0.225, 0.275, 0.225 }, { 0.3875, 0.7375, 0.85, 0.8 },
			{ 0.375, 0.4625, 0.45, 0.4125 }, { 0.375, 0.7, 1, 1 }, { 0.2625, 0.2875, 0.25, 0.325 },
			{ 0.275, 0.3125, 0.5625, 0.7 }, { 0.375, 0.5375, 0.6375, 0.6875 }, { 0.175, 0.35, 0.5375, 0.35 },
			{ 0.2875, 0.4, 0.3875, 0.3875 }, { 0.2125, 0.2375, 0.275, 0.275 }, { 0.175, 0.2875, 0.4, 0.55 },
			{ 0.5625, 0.4875, 0.4, 0.5375 }, { 0.225, 0.25, 0.25, 0.2875 }, { 0.2625, 0.8625, 0.975, 0.925 },
			{ 0.2875, 0.2125, 0.2, 0.275 }, { 0.325, 0.475, 0.525, 0.55 }, { 0.3375, 0.175, 0.25, 0.225 },
			{ 0.275, 0.2125, 0.225, 0.2375 }, { 0.175, 0.3, 0.575, 0.6875 }, { 0.35, 0.5625, 0.5125, 0.9 },
			{ 0.2375, 0.225, 0.225, 0.225 }, { 0.4125, 0.65, 0.8625, 0.9125 }, { 0.55, 0.6875, 0.6875, 0.775 },
			{ 0.275, 0.3, 0.3125, 0.2875 }, { 0.225, 0.3375, 0.375, 0.3375 }, { 0.25, 0.25, 0.25, 0.25 },
			{ 0.65, 0.8875, 0.925, 0.9125 }, { 0.3125, 0.525, 0.55, 0.6125 }, { 0.25, 0.25, 0.2375, 0.25 },
			{ 0.2, 0.2375, 0.3625, 0.25 }, { 0.225, 0.25, 0.2375, 0.2125 }, { 0.225, 0.175, 0.2625, 0.275 },
			{ 0.2, 0.6125, 0.75, 0.8375 }, { 0.2, 0.2625, 0.25, 0.55 }, { 0.45, 0.4625, 0.6, 0.525 },
			{ 0.25, 0.3375, 0.8125, 0.9625 }, { 0.275, 0.25, 0.175, 0.325 }, { 0.4375, 0.3, 0.225, 0.2625 },
			{ 0.3125, 0.425, 0.4875, 0.3375 }, { 0.35, 0.425, 0.8, 0.6625 }, { 0.225, 0.2, 0.25, 0.25 },
			{ 0.3875, 0.4375, 0.725, 0.85 }, { 0.35, 0.6375, 0.7, 0.85 }, { 0.7, 0.85, 0.8625, 0.925 },
			{ 0.2875, 0.275, 0.3375, 0.4375 }, { 0.275, 0.2375, 0.225, 0.3375 }, { 0.3625, 0.5875, 0.7875, 0.9375 },
			{ 0.425, 0.325, 0.375, 0.2875 }, { 0.475, 0.875, 0.9375, 0.925 }, { 0.2125, 0.325, 0.2625, 0.25 },
			{ 0.5, 0.8625, 0.8875, 0.925 }, { 0.3875, 0.3375, 0.35, 0.2625 }, { 0.2625, 0.5, 0.6625, 0.5875 },
			{ 0.225, 0.375, 0.375, 0.3875 }, { 0.2875, 0.2125, 0.3, 0.35 }, { 0.3, 0.3375, 0.3875, 0.4125 },
			{ 0.475, 0.7625, 0.8375, 0.7625 }, { 0.3375, 0.4, 0.4625, 0.4 }, { 0.2, 0.25, 0.2125, 0.1875 },
			{ 0.4125, 0.25, 0.3625, 0.3125 }, { 0.425, 0.5625, 0.6375, 0.6375 }, { 0.25, 0.4125, 0.5375, 0.5 },
			{ 0.5375, 0.5375, 0.475, 0.45 }, { 0.375, 0.6375, 0.9, 0.85 }, { 0.4625, 0.675, 0.675, 0.7375 },
			{ 0.2875, 0.1625, 0.3875, 0.425 }, { 0.35, 0.3125, 0.4125, 0.4 }, { 0.1875, 0.3375, 0.2, 0.1125 },
			{ 0.4375, 0.6625, 0.65, 0.7625 }, { 0.3375, 0.25, 0.4125, 0.4 }, { 0.3, 0.2375, 0.3625, 0.2375 },
			{ 0.3, 0.3125, 0.375, 0.3375 }, { 0.2375, 0.3375, 0.3, 0.2125 }, { 0.5125, 0.5625, 0.4625, 0.5125 },
			{ 0.2625, 0.3625, 0.3875, 0.2625 }, { 0.275, 0.1875, 0.275, 0.2875 }, { 0.4875, 0.575, 0.825, 0.775 },
			{ 0.5125, 0.9, 0.95, 0.95 }, { 0.35, 0.1875, 0.3625, 0.325 }, { 0.225, 0.6, 0.6, 0.4875 },
			{ 0.7375, 0.975, 0.9875, 0.975 }, { 0.375, 0.425, 0.4125, 0.4375 }, { 0.6125, 0.8625, 0.975, 0.9625 },
			{ 0.3125, 0.35, 0.525, 0.525 }, { 0.375, 0.425, 0.65, 0.775 }, { 0.2, 0.275, 0.175, 0.1875 },
			{ 0.625, 0.95, 0.925, 0.9875 }, { 0.3125, 0.375, 0.375, 0.525 }, { 0.3375, 0.3125, 0.3375, 0.1875 },
			{ 0.3, 0.175, 0.3, 0.35 }, { 0.4375, 0.6875, 0.6125, 0.6 }, { 0.3, 0.175, 0.2125, 0.2375 },
			{ 0.25, 0.325, 0.3125, 0.25 }, { 0.275, 0.2875, 0.4625, 0.7125 }, { 0.2625, 0.2625, 0.3, 0.1875 },
			{ 0.2, 0.3125, 0.275, 0.2375 }, { 0.375, 0.4, 0.6625, 0.8 }, { 0.3, 0.3375, 0.5875, 0.8375 },
			{ 0.2375, 0.25, 0.275, 0.3375 }, { 0.225, 0.25, 0.4125, 0.1875 }, { 0.2375, 0.275, 0.25, 0.3125 },
			{ 0.3, 0.3125, 0.4125, 0.2625 }, { 0.2625, 0.4, 0.3375, 0.425 }, { 0.825, 0.8375, 0.7, 0.825 },
			{ 0.3, 0.3625, 0.5125, 0.4125 }, { 0.4625, 0.5125, 0.4125, 0.5375 }, { 0.2, 0.2375, 0.2375, 0.2 },
			{ 0.2625, 0.5125, 0.4375, 0.4125 }, { 0.2375, 0.2, 0.45, 0.375 }, { 0.2125, 0.2875, 0.35, 0.275 },
			{ 0.3375, 0.275, 0.3, 0.2375 } };

	@Test
	public void GeneralModelTest() {
		double[] expectedMeans = { 0.367647058823529, 0.467647058823529, 0.575735294117647, 0.611764705882353,
				0.344485294117647, 0.443382352941177, 0.508088235294118, 0.516911764705882 };
		double[][] expectedCov = {
				{ 0.017197772491349, 0.022730860726644, 0.017445663927336, 0.018836505190311, 0, 0, 0, 0 },
	...
	public void staMRTest() {
		...
		double[] x1Expected = { 0.307307683091782, 0.336186028243926, 0.411231543807238, 0.411231543807375,
				0.411231543807457, 0.524785168266143, 0.583048612432285, 0.600042950685741 };
		double[] x2Expected = { 0.243969803017848, 0.304387501017471, 0.313993948960525, 0.313993948960525,
				0.313993948960525, 0.315929574797554, 0.327067491570140, 0.327067491570140 };
	...
	public void datafitTest() {
		...
		a.add(new SimpleLinearConstraint(8, 0, 1));
		a.add(new SimpleLinearConstraint(8, 1, 2));
		a.add(new SimpleLinearConstraint(8, 2, 3));

		a.add(new SimpleLinearConstraint(8, 4, 5));
		a.add(new SimpleLinearConstraint(8, 5, 6));
		a.add(new SimpleLinearConstraint(8, 6, 7));

		a.add(new SimpleLinearConstraint(8, 4, 0));

		a.add(new SimpleLinearConstraint(8, 5, 1));

		a.add(new SimpleLinearConstraint(8, 6, 2));

		a.add(new SimpleLinearConstraint(8, 7, 3));

		for (int i = 0; i < nvar; i++) {
			adj[i] = a;
		}

		CMRxGMFits fits = new CMRxGMFits(5, gm, model, adj, 4);

		assertEquals(1.5771779458404, fits.getDataFit(), 1e-10);
	}
